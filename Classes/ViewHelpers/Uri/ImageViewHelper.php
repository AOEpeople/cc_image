<?php
namespace CoelnConcept\CcImage\ViewHelpers\Uri;
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        try {
            ...
            if (!empty($arguments['fileExtension'])) {
                if (!in_array($arguments['fileExtension'], explode(',', $GLOBALS['TYPO3_CONF_VARS']['GFX']['imagefile_ext']))) {
                    throw new Exception('File extension '.$arguments['fileExtension'].' is not allowed. Please check [GFX][imagefile_ext] and add it.', 1586416523);
                }
